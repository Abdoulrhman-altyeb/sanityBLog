...
const Banner = () => {
  return (
      <div className='flex bg-gradient-to-t from-orangy to-orang p-8 text-white items-center'>
          <div>
            <h1 className='text-2xl md:text-4xl mb-4'><span className='text-4xl mr-1 md:mr-0'>B</span>loggy woggy your blog, create your blog for others to read,read other ppl blogs </h1>
