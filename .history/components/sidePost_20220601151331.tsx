    ...
    <Link href={`/post/${single.slug.current}`}>
        <div className='flex shadow-custom justify-between cursor-pointer mb-10 p-2 overflow-hidden group'>
          <div className='flex flex-col justify-center md:justify-between'>
            ...
            <p className='tracking-tighter text-gray-500 hidden md:block'>every blog should had at least a description for the user to know what the blog is talking about. The Description Of This Blog Is {single.description}</p>
            <p className='tracking-tighter text-gray-500 hidden md:block'></p>
