    ...
    <nav className='flex justify-between p-2'>
        <div className='flex items-center'>
          ...
          <ul className='hidden md:flex ml-4 space-x-3 text-sm font-semibold text-gray-600  md:items-center'>
              ...
              <li className='bg-gradient-to-t from-orangy to-orang text-white px-4 py-2 rounded-full inline-block cursor-pointer hover:opacity-90 transition-opacity duration-120'>Create</li>
          </ul> 
        </div>
        <div>
