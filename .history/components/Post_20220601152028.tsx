    ...
    <Link href={`/post/${single.slug.current}`}>
            <div className="flex shadow-custom flex-col cursor-pointer group">
                ...
                <div className="flex items-center p-1 justify-between">
                    ...
                    <div>
                        <img className="w-7 h-7 sm:w-12 sm:h-12 rounded-full ml-4 object-cover group-hover:scale-105" src={urlFor(single.author.image.asset._ref).url()} alt='progileImg'/>
                    </div>
                </div>
            </div>
    </Link>
