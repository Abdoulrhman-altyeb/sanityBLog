  ...
  return (
    <nav className='flex justify-between p-2'>
        ...
        <div className='flex space-x-3 items-center'>
          <img src={svg.src} alt='svg' className='h-5 w-5'/>
          <div className='flex space-x-2'>
            <span>Login</span>
            <span> / </span>
            <span>Sing up</span>
          </div>
          <button className='hidden md:block bg-gradient-to-t from-orangy to-orang text-white px-4 py-2 rounded-md'>GET STARTED</button>
        </div>
    </nav>
  )
}
