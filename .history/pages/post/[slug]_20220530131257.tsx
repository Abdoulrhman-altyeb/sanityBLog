...
export const getStaticPaths = async () => {
    ...
    const query = 'fetch the id and the path name slug for each page (the sanity brok command)'
    const posts = 'sanity fetch the query'
    const paths = 'map throw all the posts and return the path for each page with will be the slug inside a params object'
    return{
        paths,
        fallback:"blocking"
    }
...
export const getStaticProps:GetStaticProps = async({params}) => {
    ...
    const query = 'the grok command here'
