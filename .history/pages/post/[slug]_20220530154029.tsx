        ...
        <article>
            ...
            <section className="max-w-xl m-auto mb-10">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col '>
                    ...
                    <input type='text' placeholder='name' className="block w-full outline-none ring-orang hover:ring" {...register("name",{required:true})} />

                    <label className="block"><span>Email</span></label>
                    <input type='email' placeholder='email' className="block w-full outline-none ring-orang hover:ring" {...register("email",{required:true})}/>
