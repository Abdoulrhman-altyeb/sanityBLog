        ...
        <article>
            ...
            <section className="max-w-xl m-auto mb-10">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col '>
                    ...
                    <input type='text' placeholder='name' className="block w-full outline-none ring-orange-400 hover:ring px-3 py-1 shadow-custom  mb-8" {...register("name",{required:true})} />

                    <label className="block text-gray-700"><span>Email</span></label>
                    <input type='email' placeholder='email' className="block w-full outline-none ring-orange-400 hover:ring px-3 py-1 shadow-custom mb-8" {...register("email",{required:true})}/>

                    <label className="block text-gray-700"><span>Message</span></label>
                    <textarea {...register("message",{required:true})} className="block w-full outline-none ring-orange-400 hover:ring shadow-custom mb-8" placeholder='message'></textarea>
