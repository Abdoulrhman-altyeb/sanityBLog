        ...
        <article>
            ...
            <section className="max-w-xl m-auto mb-10">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col '>
                    ...
                    <textarea {...register("message",{required:true})} className="block w-full outline-none ring-orange-200 hover:ring shadow-custom mb-8" placeholder='message'></textarea>
