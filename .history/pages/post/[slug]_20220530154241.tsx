        ...
        <article>
            ...
            <section className="max-w-xl m-auto mb-10">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col '>
                    ...
                    {...register('_id')}
                    />
                    <label className="block"><span>Name</span></label>
                    <input type='text' placeholder='name' className="block w-full outline-none ring-orang hover:ring px-3 py-1 shadow-custom  mb-5" {...register("name",{required:true})} />

                    <label className="block"><span>Email</span></label>
                    <input type='email' placeholder='email' className="block w-full outline-none ring-orang hover:ring px-3 py-1 shadow-custom mb-5" {...register("email",{required:true})}/>

                    <label className="block"><span>Message</span></label>
                    <textarea {...register("message",{required:true})} className="block w-full outline-none ring-orang hover:ring shadow-custom mb-5" placeholder='message'></textarea>
